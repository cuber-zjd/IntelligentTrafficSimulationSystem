            ...
            for item_bbox in list_bboxs:
                ...
                if polygon_mask_blue_and_yellow[y, x] == 1:
                    ...
                    if track_id in list_overlapping_yellow_polygon:
                        # 上行+1
                        up_count += 1
                        print('up count:', up_count, ', up id:', list_overlapping_yellow_polygon, '通过的车辆id为', track_id,divided,fps,time),
                    ...
                    if track_id in list_overlapping_blue_polygon:
                        ...
                        down_count += 1
                        print('down count:', down_count, ', down id:', list_overlapping_blue_polygon,'车辆id:',track_id,',passtime:',second_time-first_time,
                              "firsttime:",first_time,"secondtime:",second_time,divided,fps,time)
